...
function showBasketNotice(i) {
    ...
    <div class="basketNoticeContainer"> 
        ...
        <div class="payOrderStyleNotice">  
            <div class="payOrderSpan"><span > 1. Der Mindestbestellwert liegt bei 10€ <span id="checklistOrder_1"> </span> </span></div>
        ...
        <div class="payOrderStyle_1" id="payOrderID"> 
            ...
            <div> 
                <b class="payOrderStillToPay"> 8.50€ </b>
            </div>
        </div> 
    </div>
    `;
