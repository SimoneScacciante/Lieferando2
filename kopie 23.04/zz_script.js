...
function menuLoad(i) {
    ...
    <div class="menuStyle"> 
        <div class="menuStyleSub">
           <h3> ${element['name']} </h3> 
            <p>${element['recepte']}<p>
            <b> ${parseFloat(element['price'].toFixed(2))} € </b> <!-- .toFixed(2) lässt zwei hintere Dezimalzahl erscheinen! -->  
        ...
        <div class="dishInBasketContainer">
            <div class="disnInBasketContainer_2">
                <div class="dishInBasketHead">  
                    ...
                    <div>
                        ${parseFloat(orderPriceArrayTotal[indexBasket].toFixed(2))} € <!--Zwischenpreis-->   
                    </div>  
                </div>  
...
function showBasketBill() {
    ...
    <div class="basketBillContainer"> 
        <div class="basketBillContainerSubtotal">
            ...
            <span> ${parseFloat(totalOrderSum.toFixed(2))}€ </span> 
        </div>

        <div class="basketBillContainerDeliver">
            <span> Lieferkosten </span>
            <span> ${parseFloat(deliverPrice.toFixed(2))}€ </span>
        </div>

        <div class="basketBillContainerTotal">
            <span> Gesamtpreis </span>
            <span>  ${parseFloat(totalOrderAndDeliverPrice.toFixed(2))}€ </span>
        </div> 
    </div>
    `;
...
function showTotalMobileSum() {
    ...
    <span>Warenkorb ${parseFloat(totalOrderAndDeliverPrice.toFixed(2))}€</span>
    `
    } else {
        let mobileTotalSumID = document.getElementById('mobileTotalSumID');
        mobileTotalSumID.innerHTML = /*html*/ ` 
...
function showBasketNotice(i) {
    ...
    <div class="payOrderStyle_1" id="payOrderID"> 
        ...
        <div> 
            <b class="payOrderStillToPay"> ${parseFloat(stillToPay.toFixed(2))}€</b>
        </div>
    </div>
    `;
...
function payment() {
    ...
    alert("Simone Zitrone dankt dir für deine Bestellung!");
...
/* payment Funktion funktioniert nicht ganz */