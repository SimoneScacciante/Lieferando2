...
function payment() {
    ...
    document.getElementById('overlayID').innerHTML = /*html*/ `
    <div class="overlayStyle"> 

        <div class="closePicContainer" onclick="finishPayment()">
            <img class="closePic" src="./img/closePic.ico">
        </div>

        <div>  
            <img src='./img/payment_pic.jpg'   class="imgPopup"> 
        </div> 

    </div> 
    `

    /* alert("Dr. Simone Zitrone dankt dir für deine Bestellung!"); */
